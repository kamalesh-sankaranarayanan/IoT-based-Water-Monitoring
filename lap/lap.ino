...
String locationName = "Lake1";   // Change to River1 / Tank1 / Farm1 if needed
...
void loop() {
  ...
  if (packetSize) {
    ...
    Serial.print("Mobility: "); Serial.println(stuckStatus);
    Serial.println("================================");

    // Format required by gateway.py:
    // DATA:location,ph,turbidity,temperature,tds,conductivity,methane,ammonia,distance,latitude,longitude
    // Conductivity is not sent by transmitter, so using 0 temporarily.
    Serial.print("DATA:");
    ...
    Serial.print(ammonia); Serial.print(",");
